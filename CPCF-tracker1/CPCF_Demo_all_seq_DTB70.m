...
where_is_your_DTB70_database_folder = 'D:\Tracking\DTB70\'; % 包含所有数据集图片序列的路径
type_of_assessment = 'DTB70';                                          % 要测试的类型，'UAV123_10fps', 'UAV123', 'UAV123_20L'
tracker_name = 'CPCF_DTB70';                                                 % 要测试的tracker名称
...
%             for dataset_count = 1 : 36
            ...
            seq = load_video_info_OTB([database_folder  video_name]);% 加载序列信息
            res_path = '.\res\';
            ...
            % DTB70只包含 type, res, fps, len 六个字段
            % save results
