...
%the num of seq frames
params.frames = seq.len;

%Range of the z_label
params.mag_min = 0.6;
params.mag_max = 1.2;
params.magnitude = 1;
...
params.rc_sigma_factor = 1/2;		% Response map correlation label function sigma
...
params.learning_rate = 0.042;
params.admm_gamma = 0.9 ; 
...
% Initialize
params.seq = seq;
% The high area of the response
params.rate = 0.225;
% Run tracker
results = CPCF_tracker_HOGCN(params);
end
